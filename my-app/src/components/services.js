                ...
                <div className="boxes">
                    ...
                    <div className="business">
                        <div class="container">
                            ...
                            <p className="year"> Years In Business</p>
                        </div>
                    </div>

                    <div className="client">
                        <div class="container">
                            <h2 className="ten2"> 1.5k</h2>
                            <p className="happy">Happy Clients</p>
                        </div>
                    </div>
                    ...
                    <div className="staff">
                        <div class="container">
                            <h2 className="ten4">150+ </h2>
                            <p className="trained"> Trained Staff</p>
                        </div>
                    </div>
                </div>
